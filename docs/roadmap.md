...
## Phase 5: Kit List Screen
**Goal: Multiple kits usable**

- [ ] Kit list UI (FR-01b)
- [ ] Create new kit (FR-01)
- [ ] Open kit

---

## Phase 6: Readiness System
**Goal: Identify gaps in kit coverage**

- [ ] Score calculation (FR-16)
- [ ] Missing categories (FR-17)
- [ ] Dependency warnings (FR-18)
